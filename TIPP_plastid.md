I made a mistake that Haematococcus lacustris is wrong, Haematococcus pluvialis is corrected
```
...
Haematococcus_lacustris: kingfisher get -r SRR25425436 -m ena-ascp aws-http prefetch; kingfisher get -r SRR25425437 -m ena-ascp aws-http prefetch
...
Isoetes_sinensis: kingfisher get -r SRR17640823 -m ena-ascp aws-http prefetch; kingfisher get -r SRR17640824 -m ena-ascp aws-http prefetch; kingfisher get -r SRR17640825 -m ena-ascp aws-http prefetch; kingfisher get -r SRR17640826 -m ena-ascp aws-http prefetch
